  ...
  return (
    <Document>
      <Page>
        ...
        <Text style={styles.text}>Mã hóa đơn:{props.data.code}</Text>
        <Text style={styles.text}>Giá trị:{props.data.revenue}</Text>
        <Text style={styles.text}>
          Người thanh toán:
          {props.data.provider === null
        ...
        <Text style={styles.text}>
          ...
          {props.data.payment_type === null
            ? "Chưa xác định"
            : props.data.payment_type.name}
        </Text>
        <Text style={{ ...styles.text }}>Người thanh toán Người nhận</Text>
        <Text
          style={{ ...styles.text, display: "flex", float: "right" }}
        ></Text>
      </Page>
    </Document>
  );
